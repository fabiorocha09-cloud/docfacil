  ...
  const transmitir = async () => {
    ...
    try {
      nota = await base44.entities.NotaFiscal55.create({
        ...
        dest_complemento: selectedDest?.complemento,
        dest_bairro: selectedDest?.bairro,
        dest_municipio: selectedDest?.municipio,
        dest_uf: selectedDest?.uf,
        dest_cep: selectedDest?.cep,
        dest_codigo_municipio: selectedDest?.codigo_ibge_municipio,
        dest_ie: selectedDest?.ie,
        dest_indicador_ie: selectedDest?.indIEDest || "NonTaxPayer",
        natureza_operacao: selectedNatureza?.nome,
        forma_pagamento: avancado.forma_pagamento,
        ...
        valor_frete: Number(avancado.valor_frete || 0),
        valor_seguro: Number(avancado.valor_seguro || 0),
        outras_despesas: Number(avancado.outras_despesas || 0),
        valor_desconto: Number(avancado.desconto_total || 0),
